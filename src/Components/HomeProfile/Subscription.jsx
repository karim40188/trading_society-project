  ...
  return (
    <Box sx={{}}>
     ...
     gap:'100px',
      ...
      >
        {/* Essential */}
        <Box sx={{ width: "320px", height: "500px" }}>
          <Box
            sx={{
              width: "100%",
              height: "100%",
          ...
          >
            ...
            <Typography
              sx={{ fontSize: "25px", fontWeight: "bold", lineHeight: "1" }}
            >
              Live trading
              <br />
              Trade alert
        ...
        <Box sx={{ width: "320px", height: "500px" }}>
          ...
          >
            ...
            >
              ...
              <br />
              All scanner
              <br />4 private sessions with selected coach
            </Typography>
            <Typography sx={{ mt: "3px" }}>
              Affiliate program with extra
              <br />
              Bonus
            </Typography>
            <Box
        ...
        <Box sx={{ width: "320px", height: "500px" }}>
          ...
          >
            ...
            >
              ...
              All scanner
              <br />
              8 private sessions with selected coach
              <br />
              expert course
              <br />
              Expert plus course
